...
class JobImportPromotionCodes extends JobPost {
     ...
     * @var array
     */
    protected $job = "import_promotion_codes";
     ...
     * @var array
     */
    protected $description = "Import a number of single use codes from a csv file to a Promotion.";
    ...
    private $cli_params__job = [
        ...
        "promotion_id" => ["promotion_id","The ID of the promotion to attach to codes to."],
    ...
    private $api_params_validation__job = [
        ...
        "always_required" => ["always_required" => ["file", "promotion_id"]],

...
include(dirname(__DIR__)."/Purchase/Purchase.php");         //Call Specifc//Incomplete//

class PurchaseGet extends Purchase {
     ...
     * @var array
     */
    protected $description = "Return information about a specific purchase.";
    ...
    private $cli_params__method = [
        ...
        "purchase_id" => ["id", "Purchase Id: The assigned extid or returned sid of a purchase."],
        "purchase_key" => ["key", "Purchase Key: specifies if id is a user provided extid or the system sid."],
        // "" => [],
    ];
    ...
    private $api_params_validation__method = [
        ...
        "purchase_id" => ["always_required" => ["purchase_key"]],
    ];

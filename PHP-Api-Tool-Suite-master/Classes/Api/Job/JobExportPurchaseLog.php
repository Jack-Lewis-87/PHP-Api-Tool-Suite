...
class JobExportPurchaseLog extends JobPost {
     ...
     * @var array
     */
    protected $job = "export_purchase_log";
     ...
     * @var array
     */
    protected $description = "Export purchase data from a timeperiod to a .csv file.";
    ...
    private $cli_params__job = [
        ...
        "start_date" => ["start","Start Date: Start of the date range to pull. Format is flexible, but yyyy-mm-dd is solid."],
        "end_date" => ["end","End Date: End of the date range to pull. Format is flexible, but yyyy-mm-dd is solid."],
        // "" => ["",""],
    ];

...
class JobBlastQuery extends JobPost {
     ...
     * @var array
     */
    protected $description = "Export campaign data in .csv format. Emails will be hashed, extid will not be.";

...
include(dirname(__DIR__)."/Template/Template.php");         //Call Specifc//Incomplete//

class TemplateGet extends Template {
     ...
     * @var array
     */
    protected $description = "Get information about a template.";
    ...
    private $cli_params__method = [
        ...
        "revision" => ["revision", "Revision: Get information on as specific template revision."],
        // "" => [],
    ];

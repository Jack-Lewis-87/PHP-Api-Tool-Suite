...
include_once(dirname(__DIR__)."/Content/Content.php");         //Call Specifc//Incomplete//

class ContentGet extends Content {
     ...
     * @var array
     */
    protected $description = "Return a data structure containing the content’s metadata. If the url parameter is not provided, returns the 20 most recent pieces of content.";

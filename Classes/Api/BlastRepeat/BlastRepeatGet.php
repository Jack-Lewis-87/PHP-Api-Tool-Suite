...
class BlastRepeatGet extends BlastRepeat {
     ...
     * @var array
     */
    protected $description = "Get data on a repeating campaign, or all repeating campaigns.";
    ...
    private $cli_params__method = [
        ...
        "repeat_id" => ["id", "Repeat Id: The repeat Blast to get information on."],
        // "" => [],
    ];

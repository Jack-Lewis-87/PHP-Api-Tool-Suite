...
include_once(dirname(__DIR__)."/Blast/Blast.php");         //Call Specifc//Incomplete//

class BlastGet extends Blast {
     ...
     * @var array
     */
    protected $description = "Get data on a set of Blasts or a specific blast.";
    ...
    private $cli_params__method = [
        ...
        "blast_id" => ["id","Blast Id: Returns blast with the specified blast ID."],
        "status" => ["status","Status: Returns blasts with the specified status -created, scheduled, sending, sent."],
        "vars" => ["vars","Pass 1 to return vars that have been set on this blast"],
        "list" => ["list","List: Limit returned data to a campaigns sent to a specific list."],
        "start_date" => ["start","Start Date: Limit returned data to campaigns sent after a specific date. Format is flexible, but yyyy-mm-dd is solid."],
        "end_date" => ["end","End Date: Limit returned data to campaigns sent before a specific date. Format is flexible, but yyyy-mm-dd is solid."],
        // "" => ["",""],
    ];

...
class JobExportScheduledSends extends JobPost {
     ...
     * @var array
     */
    protected $job = "export_scheduled_sends";
     ...
     * @var array
     */
    protected $description = "Download a .csv report of all currently-scheduled transactional sends.";

...
class JobGet extends Job {
     ...
     * @var array
     */
    protected $description = "Return information about an ongoing Job.";
    ...
    private $cli_params__method = [
        ...
        "job_id" => ["id", "Job Id: The id of the job to request information on."]
        // "" => [],
    ];
    ...
    private $api_params_validation__method = [
        ...
        "always_required" => ["always_required" => ["job_id"]],
        // "" => [],
    ];

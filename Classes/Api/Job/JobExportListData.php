...
class JobExportListData extends JobPost {
     ...
     * @var array
     */
    protected $job = "export_list_data";
     ...
     * @var array
     */
    protected $description = "Query your users to see who received a specific campaign, and generate a detailed snapshot of their analytics.";
    ...
    private $cli_params__job = [
        ...
        "list" => ["list","List: "],
        "fields" => ["fields", "Fields: Fields to include in the outputed .csv. Input a JSON object or each 'return field' prepended with 'field_'."],
        // "" => ["",""],
    ];

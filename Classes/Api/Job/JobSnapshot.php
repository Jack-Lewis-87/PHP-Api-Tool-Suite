...
class JobSnapshot extends JobPost {
     ...
     * @var array
     */
    protected $description = "Query your users and generate a detailed snapshot of their analytics.";
    ...
    private $cli_params__job = [
        ...
        "query" => ["query","Query: A specific query for users based on their criteria and list membership. Input a JSON object, or use the rules set out below."],
        // "" => ["",""],
    ];

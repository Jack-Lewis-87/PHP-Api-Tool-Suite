...
class IncludePost extends IncludeEndpoint {
    ...
    private $cli_params__method = [
        ...
        "content_html" => ["body","Include: The html, zephyr, and other text of the include."],
        "content_text" => ["text_only", "Text Only: The include version in text only emails ."],
        "content_sms" => ["sms", "SMS body: The include version in the context of sms."],
        "content_app" => ["app", "App Body: The include version in the context of apps."],
        // "" => [],
    ];
    ...
    private $api_params_validation__method = [
        ...
        "always_required" => ["always_required" => "include"],
        // "" => [],
    ];

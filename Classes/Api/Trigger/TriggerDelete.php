...
include_once(dirname(__DIR__)."/Trigger/Trigger.php");         //Call Specifc//Incomplete//

class TriggerDelete extends Trigger {
     ...
     * @var array
     */
    protected $description = "Delete all triggers on a template or a specific trigger.";

...
include_once(dirname(__DIR__)."/Block/Block.php");         //Call Specifc//Incomplete//

class BlockPost extends Block {
     ...
     * @var array
     */
    protected $description = "Create or modify a block.";
    ...
    private $cli_params__method = [
        ...
        "type" => ["type","Type: Html, CSS, Javascript, or Setup (zephry)."],
        "content" => ["content","Content: A string that is the body of the block."],
        "create_user" => ["creater","Create User: Email address to associate as the creater of this block."],
        "modify_user" => ["modifier","Modify User: Email address to associate as this modifier of the block."],
        // "" => ["",""],
    ];
    ...
    private $api_params_validation__method = [
        ...
        "always_required" => ["block_id" => ["name", "type", "content", "create_user"]],
        "modify_user" => ["always_required" => ["block_id"]],
        // "" => [],
    ];

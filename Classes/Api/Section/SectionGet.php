...
include_once(dirname(__DIR__)."/Section/Section.php");         //Call Specifc//Incomplete//

class SectionGet extends Section {
     ...
     * @var array
     */
    protected $description = "Return information about a section.";

...
class ListGet extends ListEndpoint {
     ...
     * @var array
     */
    protected $description = "Get basic information about a list. If no list is specified, this call will return a list of your lists";
    ...
    private $cli_params__method = [
        ...
        "list_id" => ["id","List ID: Calls a list by id number"],
        "fields" => ["fields","fields: Return spefic fields on a list. Use a JSON object or preface the field with \"field_\". Eg field_vars=1"],
        "primary" => ["primary","1 for primary, 0 for secondary list. Exclude to query for both."],
        "type" => ["type","Type: Natural or Smart aka 'natural' or 'smart'."],
        // "" => ["",""],
    ];

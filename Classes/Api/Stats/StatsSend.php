...
class StatsList extends Stats {
     ...
     * @var array
     */
    protected $description = "Return information about a particular transactional or aggregated information from transactionals from that template over a specified date range.";
    ...
    private $cli_params__method = [
        ...
        "template" => ["template","Template: The name of the template to pull information about."],
        "start_date" => ["start", "Start Date: The start of the time range to pull aggregated Send stats. Format is flexible, but yyyy-mm-dd is solid."],
        "end_date" => ["end","End Date: The end of the time range to pull aggregated Send stats. Format is flexible, but yyyy-mm-dd is solid."],
        "beacon_times" => ["beacon","Beacon Time: Specify 1 to pull information about when a particular send was opened."],
        "click_times" => ["click_times","Specify 1 to pull information about when links were clicked."],
        "clickmap" => ["clickmap","Specify 1 to pull click map information."],
        "domain" => ["domain","Specify 1 to pull information based on recipients’ email domains."],
        "engagement" => ["engagement","Specify 1 to pull information based on levels of engagement."],
        "list" => ["list","Specify this option if you want to pull send stats from one particular list."],
        "sample" => ["sample","Specify this option to get stats on one segment of an A/B split test."],
        "signup" => ["signup","Specify 1 to pull information based on signup dates."],
        "urls" => ["urls","Specify 1 to pull information based on urls."],
        // "" => ["",""],
    ];

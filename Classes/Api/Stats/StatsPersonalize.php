...
class StatsList extends Stats {
     ...
     * @var array
     */
    protected $description = "Return analytics about the sections of your website that are personalized with Personalization Engine over a specified time range.";
    ...
    private $cli_params__method = [
        ...
        "start_time" => ["start", "Start Date: The start of the time range to pull aggregated Personalization Engine stats. Format is flexible, but yyyy-mm-dd is solid."],
        "end_date" => ["end","End Date: The end of the time range to pull aggregated Personalization Engine stats. Format is flexible, but yyyy-mm-dd is solid."],
        // "" => ["",""],
    ];

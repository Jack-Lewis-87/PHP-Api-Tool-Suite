...
class StatsGet extends Stats {
     ...
     * @var array
     */
    protected $description = "Return Various Stats.";
    ...
    private $cli_params__method = [
        ...
        "stat" => ["stat", "Stat: The stats to retrieve. There are seperate classes for easier use of each stat type. List, Blast, Send, and Personalize"],
        // "" => ["",""],
    ];
    ...
    private $api_params_validation__method = [
        ...
        "always_required" => ["always_required" => ["stat"]],
        // "" => [],
    ];

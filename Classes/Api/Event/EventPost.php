...
include_once(dirname(__DIR__)."/Event/Event.php");         //Call Specifc//Incomplete//
...
class EventPost extends Event {
     ...
     * @var array
     */
    protected $description = "Fire an Event into Sailthru to activate a global trigger.";
    ...
    private $cli_params__method = [
        ...
        "event" => ["event","Event: The name of the event."],
        "id" => ["id","Id: The user identifier, can be any valid user key."],
        "key" => ["id_key","Key: The type of key used in id."],
        "vars" => ["vars", "Event Vars: Add a arbitrary event vars. Input a JSON object or enter each var name prepended with \"var_\" eg: var_venue=\"Pool House\"."],
        // "" => [],
    ];

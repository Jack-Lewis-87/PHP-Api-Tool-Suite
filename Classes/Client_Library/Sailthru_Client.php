...
class Sailthru_Client {
     ...
     */
    public function processJob($job, array $options = array(), $report_email = false, $postback_url = false, array $binary_data_param = array()) {
        $data = $options;
        $data['job'] = $job;
        if ($report_email) {
    ...
    public function deleteJob($id) {
        return $this->apiDelete('job', array('job_id' =>$id));
    }

    /**
     * Process List Generate job from Query
     * @param String $query
     * @param String $target_list
     * @param String $report_email
     * @param String $postback_url
     */
    public function processListGenJob($query, $target_list, $report_email = false, $postback_url = false) {
        $data = array(
            'query' => $query,
            'target_list' => $target_list
        );
        return $this->processJob('list_gen', $data, $report_email, $postback_url);
    }
    ...
    /**
     * Perform a bulk  of any number of user profiles from given context: String CSV, file, URL or query
